...
hlightning.xyz2xyz = function(codename, x1, y1, z1, x2, y2, z2, during)
    local lightning = cj.AddLightningEx(hSys.getObjId(codename), true, x1, y1, z1, x2, y2, z2)
    if (during > 0) then
...
hlightning.loc2loc = function(codename, loc1, loc2, during)
...
hlightning.unit2unit = function(codename, unit1, unit2, during)
    return hlightning.xyz2xyz(
            codename,
